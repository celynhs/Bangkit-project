...
def get_recommendations():
    # Load the dataset
    df = pd.read_csv('C:/Users/DELL/Downloads/capstone/final_dataset.csv')
    df = df.drop(["Unnamed: 0"], axis=1)

    # Load the models
    loaded_cbf_model = load_model('C:/Users/DELL/Downloads/capstone/cbf_model.h5')
    loaded_clf_model = load_model('C:/Users/DELL/Downloads/capstone/clf_model.h5')
